...
class LinksSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        categories = {'the-gioi': 1001002, 'the-thao': 1002565,
                      'phap-luat': 1001007, 'giai-tri': 1002691,
                      'giao-duc': 1003497, 'khoa-hoc': 1001009,
                      'oto-xe-may': 1001006, 'kinh-doan': 1003159,
                      'so-hoa': 1002592, 'gia-dinh': 1002966,
                      'suc-khoe': 1003784}
    ...
    def parse(self, response):
        ...
        """
        links = response.css(
            "ul.list_news  div.title_news a::attr(href)").extract()
...
class NewsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        title = container.css(
            "div.title_news h1::text").extract_first().strip()
        short_intro = container.css(
            ".short_intro::text").extract_first().strip()
